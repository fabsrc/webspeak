...
class WordsControllerTest < ActionController::TestCase
  ...
  test "should get show with existing Word" do
    @test_word = Word.create title: "Test-Title", body: "Some Text for the Test."
  ...
  test "should create word" do
    assert_difference('Word.count') do
      post :create, word: {title: 'Test Title', body: 'Some Text for the body.'}
    end
  ...
  test "should update word" do
    @test_word = Word.create title: "Test Title", body: "Test body for the Test of Update."
